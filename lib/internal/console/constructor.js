...
function onConsoleMessage(level, args) {
  if (process.isRecordingOrReplaying()) {
    process.recordReplayOnConsoleAPI(level, /* numStackFrames */ 2, args);
  }
}

const consoleMethods = {
  log(...args) {
    onConsoleMessage("info", args);
    this[kWriteToConsole](kUseStdout, this[kFormatForStdout](args));
  },


  warn(...args) {
    onConsoleMessage("warning", args);
    this[kWriteToConsole](kUseStderr, this[kFormatForStderr](args));
  },

  error(...args) {
    onConsoleMessage("error", args);
    this[kWriteToConsole](kUseStderr, this[kFormatForStderr](args));
  },
