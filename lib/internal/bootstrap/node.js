...
// Set up methods on the process object for all threads
{
  ...
  process.isRecordingOrReplaying = rawMethods.isRecordingOrReplaying;
  process.recordReplayLog = rawMethods.recordReplayLog;
  process.recordReplayAssert = rawMethods.recordReplayAssert;
  process.recordReplayOnConsoleAPI = rawMethods.recordReplayOnConsoleAPI;
  process.recordReplayRecordingId = rawMethods.recordReplayRecordingId;
  process.recordReplayCurrentExecutionPoint = rawMethods.recordReplayCurrentExecutionPoint;
  process._recordReplayIgnoreScript = rawMethods.recordReplayIgnoreScript;
  process._recordReplaySetCommandCallback = rawMethods.recordReplaySetCommandCallback;
  process._recordReplaySetClearPauseDataCallback = rawMethods.recordReplaySetClearPauseDataCallback;
  process._recordReplaySetCDPMessageCallback = rawMethods.recordReplaySetCDPMessageCallback;
  process._recordReplaySendCDPMessage = rawMethods.recordReplaySendCDPMessage;
  process._recordReplayGetCurrentError = rawMethods.recordReplayGetCurrentError;
